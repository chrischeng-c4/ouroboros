...
- [x] 2.1 Create new crate `crates/ouroboros-cli` with `clap`.
- [x] 2.2 Implement main entry point `ob`.
- [x] 2.3 Implement `ob qc` subcommand structure.
- [x] 2.4 Wire `ob qc run` to the test runner logic.
- [x] 2.5 Wire `ob qc collect` to the discovery logic.
...
## 4. Integration
- [x] 4.1 Expose `ouroboros_cli` as a binary or Python entry point.
- [x] 4.2 Verify `ob qc run` executes existing tests correctly.
