...
try:
    from data_bridge.data_bridge.http import HttpClient, HttpResponse
except ImportError:
    # Fallback for different import paths
    try:
        from data_bridge._data_bridge.http import HttpClient, HttpResponse
    except ImportError:
        from data_bridge.data_bridge import http as _http_module
        HttpClient = _http_module.HttpClient
        HttpResponse = _http_module.HttpResponse
