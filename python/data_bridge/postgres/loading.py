...
Example:
    ...
    >>> from data_bridge.postgres.loading import joined, selectinload, raiseload
    >>>
    >>> class User(Table):
...
def lazy() -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import lazy
...
def joined(innerjoin: bool = False) -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import joined
...
def subquery() -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import subquery
...
def selectinload() -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import selectinload
        >>> users = await User.fetch_many(load_strategy=selectinload())
...
def noload() -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import noload
...
def raiseload(sql_only: bool = False) -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import raiseload
        >>>
...
def defer(*columns: str) -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import defer
...
def undefer(*columns: str) -> LoadingConfig:
    ...
    Example:
        >>> from data_bridge.postgres.loading import undefer
