...
```python
from data_bridge.tasks import Chain
...
```python
from data_bridge.tasks import Group
...
```python
from data_bridge.tasks import Chord
...
- Python 3.12+
- data-bridge (built with maturin)
...
```python
ImportError: data-bridge-tasks extension not built
```
...
- [data-bridge Repository](https://github.com/your-org/data-bridge)
