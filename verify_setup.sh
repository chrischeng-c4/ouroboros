...
echo "  uv run python python/examples/agent/integration_test.py"
echo ""
echo "Or run individual examples:"
echo "  uv run python python/examples/agent/simple_agent.py"
echo "  uv run python python/examples/agent/tool_agent.py"
echo ""
