...
//! following the same security-focused approach as `crates/data-bridge/src/validation.rs`.
//!
//! # Architecture
//!
//! ## Validation Layers
...
//!
//! ```rust
//! use data_bridge_api::validation::{RequestValidator, ParamValidator, ParamLocation, TypeDescriptor};
