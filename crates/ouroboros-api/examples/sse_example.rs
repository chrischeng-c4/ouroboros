//! Example demonstrating Server-Sent Events (SSE) usage with ouroboros-api
//!
//! This example shows how to create SSE streams and responses.
//!
//! Run with: cargo run --package ouroboros-api --example sse_example

use ouroboros_api::sse::{SseEvent, SseStream, SseResponse, keep_alive_stream, merge_streams};
