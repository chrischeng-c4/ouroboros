//! OpenTelemetry tracing integration for ouroboros-api
//!
...
//! # Example
//! ```no_run
//! use ouroboros_api::telemetry::{TelemetryConfig, init_telemetry};
//!
...
impl Default for TelemetryConfig {
    fn default() -> Self {
        Self {
            service_name: "ouroboros-pyloop".to_string(),
...
mod tests {
    ...
    fn test_telemetry_config_default() {
        let config = TelemetryConfig::default();
        assert_eq!(config.service_name, "ouroboros-pyloop");
