...
impl Router {
    ...
    ///
    /// ```rust,no_run
    /// use ouroboros_api::{Router, Request, Response};
    /// use ouroboros_api::validation::{RequestValidator, ValidatedRequest};
    /// use ouroboros_api::handler::HandlerMeta;
    /// use ouroboros_api::error::ApiResult;
    /// use std::sync::Arc;
    ///
    ...
    ///
    /// ```rust,no_run
    /// use ouroboros_api::{Router, PythonHandler};
