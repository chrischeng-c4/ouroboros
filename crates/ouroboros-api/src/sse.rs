//! Server-Sent Events (SSE) support for ouroboros-api
//!
//! This module provides Server-Sent Events functionality for real-time
//! server-to-client streaming. It follows the ouroboros architecture principles:
...
//!
//! ```rust
//! use ouroboros_api::sse::{SseEvent, SseStream, SseResponse};
...
impl SseEvent {
    ...
    /// # Example
    /// ```
    /// use ouroboros_api::sse::SseEvent;
    ///
...
impl SseStream {
    ...
    /// # Example
    /// ```
    /// use ouroboros_api::sse::{SseEvent, SseStream};
    /// use async_stream::stream;
    ///
    /// let event_stream = stream! {
...
/// # Example
/// ```
/// use ouroboros_api::sse::keep_alive_comment;
///
...
/// # Example
/// ```
/// use ouroboros_api::sse::keep_alive_stream;
...
/// # Example
/// ```
/// use ouroboros_api::sse::{SseEvent, merge_streams};
/// use async_stream::stream;
///
/// # async fn example() {
