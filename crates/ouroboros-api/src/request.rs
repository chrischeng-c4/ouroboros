...
//! `crates/ouroboros/src/conversion.rs`.
//!
//! # Architecture
//!
...
// Re-export HttpMethod from ouroboros-common
pub use ouroboros_common::http::HttpMethod;
...
/// # Example
/// ```rust,no_run
/// use ouroboros_api::request::parse_multipart;
///
...
/// # Example
/// ```rust
/// use ouroboros_api::request::parse_urlencoded;
///
