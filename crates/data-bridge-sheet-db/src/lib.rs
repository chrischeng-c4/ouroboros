//! # data-bridge-sheet-db
//!
//! High-performance spreadsheet database layer built on top of data-bridge-kv.
//!
//! ## Architecture
//!
//! This crate provides:
...
//!
//! ```rust,ignore
//! use data_bridge_sheet_db::storage::CellStore;
//! use data_bridge_sheet_db::query::RangeQuery;
//!
//! // Create cell store
