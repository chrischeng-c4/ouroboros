...
impl QueryBuilder {
    ...
    /// # Example
    /// ```
    /// use ouroboros_postgres::QueryBuilder;
    /// # use ouroboros_postgres::Result;
    /// # fn main() -> Result<()> {
    ...
    /// # Example
    /// ```
    /// use ouroboros_postgres::{QueryBuilder, OrderDirection};
    /// # use ouroboros_postgres::Result;
    /// # fn main() -> Result<()> {
    ...
    /// # Example
    /// ```
    /// use ouroboros_postgres::{QueryBuilder, WindowFunction, WindowSpec, OrderDirection};
    ///
    ...
    /// # Example
    /// ```
    /// use ouroboros_postgres::{QueryBuilder, AggregateFunction, Operator, ExtractedValue};
    ///
