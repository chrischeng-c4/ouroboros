...
//!
//! This module provides comprehensive performance analysis tools for data-bridge:
//!
...
//!
//! ```rust
//! use data_bridge_test::performance::boundary::BoundaryTracer;
//!
...
//!
//! ```rust
//! use data_bridge_test::performance::boundary::BoundaryMetrics;
//! use std::sync::Arc;
//!
