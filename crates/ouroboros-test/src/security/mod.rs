//! Security testing framework for ouroboros
//!
...
//! # Example
//! ```rust,ignore
//! use ouroboros_test::security::{PayloadDatabase, Fuzzer, FuzzConfig};
//!
...
//!
//! // Async fuzzing
//! use ouroboros_test::security::{AsyncFuzzer, AsyncFuzzConfig};
//!
