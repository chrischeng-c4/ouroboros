...
//! ```bash
//! cargo run --example junit_reporter_example -p ouroboros-test
//! ```

use ouroboros_test::reporter::{Reporter, TestReport};
use ouroboros_test::runner::{TestMeta, TestResult, TestStatus, TestType};
use std::fs;
use std::io::Write;
