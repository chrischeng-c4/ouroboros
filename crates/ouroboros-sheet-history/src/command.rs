use ouroboros_sheet_core::{Cell, CellContent, CellCoord, CellFormat, CellRange, CellValue, Sheet};
use ouroboros_sheet_core::sheet::FilterState;
use ouroboros_sheet_formula::{shift_formula_rows, shift_formula_cols};
...
impl SetCellValueCommand {
    ...
    pub fn from_input(coord: CellCoord, input: &str) -> Self {
        let content = ouroboros_sheet_core::sheet::parse_cell_input(input);
