//! Benchmark tests for data-bridge-postgres
//!
//! Tests performance of critical PostgreSQL operations using the data-bridge-test framework.

use data_bridge_postgres::{QueryBuilder, Operator, OrderDirection, ExtractedValue, JoinType, JoinCondition};
use data_bridge_test::{expect, AssertionError};
use data_bridge_test::benchmark::{Benchmarker, BenchmarkConfig, print_comparison_table};
