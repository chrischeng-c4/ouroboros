...
fn bench_set_single_threaded(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_get_single_threaded(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
...
fn bench_mixed_workload(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
...
fn bench_incr_operations(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
...
fn bench_decr_operations(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
    let key = KvKey::new("counter").unwrap();
...
fn bench_set_concurrent_2_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_set_concurrent_4_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let config = benchmarker.config();
    let total_ops = (config.iterations * config.rounds) as usize;
...
fn bench_set_concurrent_8_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let config = benchmarker.config();
    let total_ops = (config.iterations * config.rounds) as usize;
...
fn bench_get_concurrent_2_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = Arc::new(KvEngine::new());
...
fn bench_get_concurrent_4_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = Arc::new(KvEngine::new());
...
fn bench_get_concurrent_8_threads(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = Arc::new(KvEngine::new());
...
fn bench_lock_contention(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let config = benchmarker.config();
    let total_ops = (config.iterations * config.rounds) as usize;
    let ops_per_thread = total_ops / 4;
...
fn bench_memory_100k_entries(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_ttl_cleanup(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_insert_1k_entries(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_insert_10k_entries(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_insert_100k_entries(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_insert_1m_entries(_benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
...
fn bench_cas_operations(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
...
fn bench_setnx_operations(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
    let mut counter = 0;
...
fn bench_exists_checks(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let engine = KvEngine::new();
...
fn bench_delete_operations(benchmarker: &Benchmarker) -> data_bridge_test::benchmark::BenchmarkResult {
    let config = benchmarker.config();
    let total_ops = (config.iterations * config.rounds) as usize;
