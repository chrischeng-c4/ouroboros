...
# Sample table models for benchmarking
class User(Table):
...
class TestPostgresBenchmarks:
    ...
    async def test_benchmark_table_instantiation(self):
        ...
        # Run benchmark with auto-calibration
        result = await benchmark(
            create_table,
            name="Table Instantiation",
            auto=True,
    ...
    async def test_benchmark_table_instantiation_bulk(self):
        ...
        # Assert reasonable performance (< 50ms for 100 instances)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_querybuilder_construction(self):
        ...
        result = await benchmark(
            ...
            name="QueryBuilder Construction",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
    ...
    async def test_benchmark_querybuilder_with_filter(self):
        ...
        # Run benchmark
        result = await benchmark(
            create_query_with_filter,
            name="QueryBuilder with Filter",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
    ...
    async def test_benchmark_querybuilder_complex_filter(self):
        ...
        result = await benchmark(
            ...
            name="QueryBuilder Complex Filter",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
        ...
        # Assert reasonable performance (< 2ms per operation)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_column_comparison_eq(self):
        ...
        # Assert reasonable performance (< 0.2ms per operation)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_column_comparison_complex(self):
        ...
        # Run benchmark
        result = await benchmark(
            create_complex_comparison,
            name="Column Complex Comparison",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
    ...
    async def test_benchmark_table_to_dict_bulk(self):
        ...
        # Assert reasonable performance (< 30ms for 100 instances)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_column_access(self):
        ...
        result = await benchmark(
            access_columns,
            name="Column Attribute Access (6x)",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
        ...
        # Assert reasonable performance (< 0.1ms for 6 accesses)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_column_assignment(self):
        ...
        result = await benchmark(
            assign_columns,
            name="Column Attribute Assignment (4x)",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
        ...
        # Assert reasonable performance (< 0.2ms for 4 assignments)
        expect(result.success).to_be_true()
        expect(result.stats.mean_ms).to_be_less_than(0.2)
...
class TestQueryBuilderBenchmarks:
    ...
    async def test_benchmark_querybuilder_limit_offset(self):
        ...
        # Run benchmark
        result = await benchmark(
            create_query_with_pagination,
            name="QueryBuilder Pagination",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
    ...
    async def test_benchmark_querybuilder_order_by(self):
        ...
        # Run benchmark
        result = await benchmark(
            create_query_with_ordering,
            name="QueryBuilder Order By",
            auto=True,
            target_time_ms=100.0,
            rounds=5,
        )
        ...
        # Assert reasonable performance (< 1.5ms per operation)
        expect(result.success).to_be_true()
    ...
    async def test_benchmark_querybuilder_full_chain(self):
        ...
        # Assert reasonable performance (< 3ms per operation)
        expect(result.success).to_be_true()
